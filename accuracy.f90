module accuracy
  ...
  public epsil,small_,sqrt2,sqrt3,rad,fititermax
  !
  ...
  integer, parameter :: ark         = selected_real_kind(18,35)  ! "Accurate" reals and complex (complexi? :-)
  ...
  ! universal constants
  real(drk), parameter :: planck     =  6.6260693e-27             ! Planck constant
  ...
  real(drk), parameter :: bohr       =  0.529177249               ! Boltzmann constant
  ...
  real(rk)           :: pi,twopi                                 ! Pi, 2*Pi
  real(rk)           :: epsil(3,3,3)                             ! epsil - antisymmetric tensor
